    ...
    describe('openBoxCtrl', function () {
        ...
        describe('build query function', function () {
            ...
            it('should build a query string', function (){
                expect(scope.buildRemixQuery()).toEqual('https://api.bestbuy.com/beta/products/openBox&callback=JSON_CALLBACK&pageSize=10&page=1');
            });
            ...
            it('should build a query string with the right options', function (){
                ...
                expect(scope.buildRemixQuery()).toEqual('https://api.bestbuy.com/beta/products/openBox(categoryId=pcmcat209400050001)&callback=JSON_CALLBACK&pageSize=10&page=1');
            });
            it('should build a query string with the right options', function (){
            ...
            it('should build a query string with the right options', function (){
                ...
                expect(scope.buildRemixQuery()).toEqual('https://api.bestbuy.com/beta/products/openBox(sku%20in(123,321))&callback=JSON_CALLBACK&pageSize=10&page=1');
            });
            it('should build a query string with the right options', function (){
                scope.searchSelection.value = "singleSku";
                scope.singleSku = '123';
                expect(scope.buildRemixQuery()).toEqual('https://api.bestbuy.com/beta/products/123/openBox&callback=JSON_CALLBACK&pageSize=10&page=1');
            });
    });
