...
angular.module('bby-query-mixer.productSearch').constant('attributeOptionsConfig', [ 
	...
	{text:'Free Shipping', value:'freeShipping', operator:[{value:'='}], placeholder:true, type:"boolean", valueOptions:[{value:true},{value:false},{value:'*'}] },
	...
	{text:'Online Availability', value:'onlineAvailability', operator:[{value:'='}], placeholder:true, type:"boolean", valueOptions:[{value:true},{value:false},{value:'*'}] },
	{text:'On Sale', value:'onSale', operator:[{value:'='}], placeholder:true, type:"boolean", valueOptions:[{value:true},{value:false},{value:'*'}] },
	{text:'Percent Savings', value:'percentSavings', operator:[{value:'='},{value:'>'},{value:'<'},{value:'<='},{value:'>='}], placeholder:'10', type:"number"},
	{text:'Preowned', value:'preowned', operator:[{value:'='}], placeholder:true, type:"boolean", valueOptions:[{value:true},{value:false},{value:'*'}] },
