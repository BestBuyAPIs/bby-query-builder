...
angular.module('bby-query-mixer.stores').constant('storeServicesConfig', [ 
	...
	{ text:'Best Buy Marine - Powered by Geek Squad', value: 'best buy marine powered by geek squad' },
	{ text:'Best Buy Mobile', value: 'best buy mobile' },
	{ text:'Best Buy Mobile Specialty Store', value: 'best buy mobile specialty store' },
	{ text:'Camera Experience Shop', value: 'camera experience shop' },
	{ text:'Car & GPS Installation Services', value: 'car & gps installation services' },
	{ text:'Comcast Connection Center', value: 'comcast connection center' },
	...
	{ text:'In-Store Gift Center', value: 'in-store gift center' },
